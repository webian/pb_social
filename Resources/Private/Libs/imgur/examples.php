...
//$imgur->account("me")->basic();
//var_dump($imgur->account("FinallyIFoundAUsernameThatsNotTaken")->basic());
//$imgur->account("username")->albums($page = 0);
//var_dump($imgur->account("username")->images($page = 0));
...
//var_dump($imgur->gallery()->search('test'));
